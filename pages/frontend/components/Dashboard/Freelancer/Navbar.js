...
function NavbarFreelancer(props) {
        ...
        <div className={styles.root}>
          ...
          >
            ...
            <ListItem
              onClick={() => {
                navigate(
                  "/frontend/components/FreelancerDashboards/DashboardSearchAgencies"
                );
              }}
              sx={{ color: postJobsColor }}
              className={styles.xyz}
            ...
            >
              ...
              <ListItemText primary="Search Agency" />
            </ListItem>
            <ListItem className={styles.xyz} button>
              <InsertChart style={{ marginRight: "10px" }} />
